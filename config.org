...
** Restart-emacs
[[https://github.com/iqbalansari/restart-emacs][restart-emacs]] adds just two functions `restart-emacs` to restart the running instance and `restart-emacs-start-new-emacs`to start a new instance.
#+begin_src emacs-lisp
