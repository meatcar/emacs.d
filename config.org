...
We want to Emacs to not ask us when trying to open a symlink.
...
** General settings
Essentially what [[https://github.com/tpope/vim-sensible][vim-sensible]] does, but we use [[https://github.com/hrs/sensible-defaults.el][sensible-defaults.el]] in emacs.
...
(setq confirm-kill-emacs nil ; unset from sensible-defaults
